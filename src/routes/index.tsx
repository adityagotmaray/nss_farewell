...
const JUNIORS_MESSAGE = `From every junior who looked up to you,
who learned from your every drive, every camp, every shout of "NSS!" —
thank you for the example you set.
This little corner is ours, for you.`;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-[100svh] flex flex-col items-center justify-center text-center px-6 py-16">
        ...
        >
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed italic border-l-2 border-accent pl-4">
          </p>
        </div>
