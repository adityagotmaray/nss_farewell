...
function JourneyPage() {
    ...
    if (!vantaEffect) {
      setVantaEffect(
        CLOUDS({
          ...
          minHeight: 200.0,
          minWidth: 200.0,
          // CUSTOM COLORS TO MATCH YOUR NAVY THEME
          backgroundColor: 0x02040a, // Deep Navy
          skyColor: 0x0b132b,       // Midnight Blue
          cloudColor: 0x1c2541,     // Soft Blue Gray
          cloudShadowColor: 0x02040a,
          sunColor: 0xd4af37,       // Hint of Gold
          sunGlareColor: 0x02040a,
          sunlightColor: 0x02040a,
          speed: 1.0
        })
      );
    }
  ...
  return (
    <div ref={vantaRef} className="relative min-h-screen text-foreground overflow-x-hidden selection:bg-accent/20">
      <TopNav />

      {/* This div darkens the clouds slightly so text is easier to read */}
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
          ...
          <div className="absolute bottom-10 animate-bounce opacity-40">
             <div className="w-px h-12 bg-accent mx-auto" />
          </div>
        </section>
        ...
        <div ref={storyRef} className="pt-32 pb-24 px-6 text-center">
            ...
            <Reveal delay={200}>
                <h1 className="font-display text-2xl sm:text-6xl relative inline-block text-white">
        ...
        <section className="relative pb-40 px-6 max-w-5xl mx-auto">
          ...
          <div className="space-y-32">
            {TIMELINE.map((t, i) => {
              const isLeft = i % 2 === 0;
              return (
                <div key={t.year} className={`relative pl-12 sm:pl-0 sm:grid sm:grid-cols-2 sm:gap-20 items-center animate-in fade-in slide-in-from-bottom-10 duration-1000 ${isLeft ? "" : "sm:[&>*:first-child]:order-2"}`}>
                  ...
                  <div className="p-6 rounded-2xl bg-black/20 border border-white/5 backdrop-blur-md shadow-2xl hover:bg-black/40 transition-all group">
        ...
        <footer className="py-20 text-center border-t border-white/5 bg-black/40">
            <p className="font-script text-accent text-3xl mb-4">Not Me, But You</p>
